...
export class BatchScaffoldCommand {
    ...
    public async execute(uri?: vscode.Uri) {
        try {
            ...
            if (confirmation === 'Cancel' || !confirmation) return;
            ...
            await vscode.window.withProgress({
                ...
                const summary = { success: [] as string[], skipped: [] as string[], failed: [] as string[] };
    ...
    private async showResults(results: { success: string[]; skipped: string[]; failed: string[] }, autoOpen: boolean) {
